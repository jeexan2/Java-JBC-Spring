...
$(document).ready(function () {
   ...
   $('#permanentThanaId').on("change",function () {
    ...
    $('#permanentPhoneNumber').on("keyup",function(){
       if(validateContactNumber($('#permanentPhoneNumber').val())){
           $('.permanentPhoneNumber').remove();
       }
    });

    $('#cellNumber').on("keyup",function(){
       if(validateContactNumber($('#cellNumber').val())){
           $('.cellNumber').remove();
       }
    });
    ...
    $('#employeeAddressForm').on("submit",function (e) {
        ...
        flag = contactPartValidation();
   // $('#employeeAddressForm').validate();
    ...
    function contactPartValidation() {
        var flag = true;
        var cellValue = $('#cellNumber').val();
        if(!validateContactNumber(cellValue)){
            flag = false;
            $('#cellNumber').
                after('<span class=cellNumber>Cell Number must be in right format!</span>');
            $('.cellNumber').addClass("error");
        }
        var perMobile = $('#permanentPhoneNumber').val();
        if(!validateContactNumber(perMobile)){
            flag = false;
            $('#permanentPhoneNumber').
                after('<span class=permanentPhoneNumber>Phone Number must be in right format!</span>');

            $('.permanentPhoneNumber').addClass("error");
        }
        return flag;
    }
